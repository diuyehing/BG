...
3. **Present 2-3 strategic options:**
   ...
   - *After the full analysis, ask the user in an Issue comment to capture the decision*
...
Use Issue comments to present strategic decisions with structured option lists.
Follow the **Explain → Capture** pattern:

1. **Explain first** — Write full strategic analysis in the Issue comment: options with
...
- Batch up to 4 independent questions in one Issue comment
...
**Example — strategic decision (after full analysis in Issue comment):**
